...
@Component({
  ...
  'selector' : 'app-acr-entries',

  'templateUrl' : './acr-entries.component.html',

  'styleUrls' : ['./acr-entries.component.css'] ,
...
export class AccountChangeRequestEntriesComponent implements OnInit {

  constructor(private route : ActivatedRoute , private location : Location ,

              private grs : AccountChangeRequestService , private gss : GeneralSearchService , private gas : GeneralAllService ,

              private ems : ErrorMessagesService , private ns : NotificationService , private aus : AuthenticationService) { 

    this.entriesSearchedOb = this.gss.entriesSearched$.subscribe((result : AccountChangeRequest[]) => {
  ...
  public entries : AccountChangeRequest[] = [];
  ...
  public trackByAppNumber(idx : number , entry : AccountChangeRequest) : string {
  ...
  ngOnInit() : void {
    ...
    this.grs.$systemType = this.systemType;
     ...
     this.route.queryParamMap.subscribe((params : ParamMap) => {
       ...
       this.$link = `account-change-request`;
