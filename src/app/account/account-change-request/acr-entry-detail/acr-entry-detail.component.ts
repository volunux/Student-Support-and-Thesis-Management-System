...
@Component({
  ...
  'selector' : 'app-acr-entry-detail',

  'templateUrl' : './acr-entry-detail.component.html',

  'styleUrls' : ['./acr-entry-detail.component.css'] ,
...
export class AccountChangeRequestEntryDetailComponent implements OnInit {

  constructor(public router : Router , private route : ActivatedRoute , public acrs : AccountChangeRequestService , 

  						public ns : NotificationService , public acrfs : AccountChangeRequestFormService , public ems : ErrorMessagesService ,
  ...
  public updateEntry($entry : AccountChangeRequest) : void {
