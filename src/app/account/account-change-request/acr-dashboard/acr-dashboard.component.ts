...
@Component({
  ...
  'selector' : 'app-acr-dashboard',

  'templateUrl' : './acr-dashboard.component.html',

  'styleUrls' : ['./acr-dashboard.component.css'] ,

  'animations' : [fadeAnimation]

})

export class AccountChangeRequestDashboardComponent implements OnInit {
