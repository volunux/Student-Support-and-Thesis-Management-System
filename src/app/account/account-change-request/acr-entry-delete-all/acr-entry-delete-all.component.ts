...
@Component({
  ...
  'selector' : 'app-acr-entry-delete-all',

  'templateUrl' : './acr-entry-delete-all.component.html',

  'styleUrls' : ['./acr-entry-delete-all.component.css'] ,
...
export class AccountChangeRequestEntryDeleteAllComponent implements OnInit {
  
	constructor(private route : ActivatedRoute , private router : Router , private acrs : AccountChangeRequestService , private ems : ErrorMessagesService , private ns : NotificationService) { 
  ...
  public $entryChanges(data) {
    ...
    this.entryChangesT = setTimeout(() => {
      ...
      return this.router.navigate(['system' , 'account-change-request']); } , 5000) 
  }
