...
@Component({
  ...
  'selector' : 'app-mr-create-reply',

  'templateUrl' : './mr-create-reply.component.html',

  'styleUrls' : ['./mr-create-reply.component.css'],

  'providers' : [ErrorMessagesService , NotificationService]

})

export class MiscRequestCreateReplyComponent implements OnInit {
