...
@Component({
  ...
  'selector' : 'app-mr-create-comment',

  'templateUrl' : './mr-create-comment.component.html',

  'styleUrls' : ['./mr-create-comment.component.css'],

  'providers' : [ErrorMessagesService , NotificationService]

})

export class MiscRequestCreateCommentComponent implements OnInit {

  constructor(private route : ActivatedRoute , private router : Router , private acrs : MiscRequestService ,
