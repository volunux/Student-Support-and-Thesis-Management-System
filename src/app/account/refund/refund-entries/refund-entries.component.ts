...
export class RefundEntriesComponent implements OnInit {
  ...
  constructor(private route : ActivatedRoute , private location : Location ,
              ...
              private rfs : RefundService , private gss : GeneralSearchService , private gas : GeneralAllService ,

              private ems : ErrorMessagesService , private ns : NotificationService , private aus : AuthenticationService) { 

    this.entriesSearchedOb = this.gss.entriesSearched$.subscribe((result : Refund[]) => {
  ...
  public trackByAppNumber(idx : number , entry : Refund) : string {
