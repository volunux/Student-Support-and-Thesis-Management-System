...
@Component({
  ...
  'selector' : 'app-user-upload-entries',

  'templateUrl' : './user-upload-entries.component.html',

  'styleUrls' : ['./user-upload-entries.component.css'] ,
...
export class UserUploadEntriesComponent implements OnInit {

  constructor(private route : ActivatedRoute , private location : Location ,

              private rcs : UserUploadService , private gss : GeneralSearchService , private gas : GeneralAllService ,

              private ems : ErrorMessagesService , private ns : NotificationService , private aus : AuthenticationService) { 

    this.entriesSearchedOb = this.gss.entriesSearched$.subscribe((result : UserUpload[]) => {
  ...
  public trackByNum(idx : number , entry : UserUpload) : string {
