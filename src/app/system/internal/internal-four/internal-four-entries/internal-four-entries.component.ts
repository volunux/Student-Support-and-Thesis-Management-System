...
export class InternalFourEntriesComponent implements OnInit {

  constructor(private route : ActivatedRoute , private location : Location ,

              private its : InternalFourService , private gss : GeneralSearchService , private gas : GeneralAllService ,

              private ems : ErrorMessagesService , private ns : NotificationService , private aus : AuthenticationService) { 

    this.entriesSearchedOb = this.gss.entriesSearched$.subscribe((result : InternalFour[]) => {
  ...
  public trackByNum(idx : number , entry : InternalFour) : string {
