...
@Component({
  ...
  'selector' : 'app-rcmtt-entries',

  'templateUrl' : './rcmtt-entries.component.html',

  'styleUrls' : ['./rcmtt-entries.component.css'] ,
...
export class RequestChangeMessageTemplateTypeEntriesComponent implements OnInit {

  constructor(private route : ActivatedRoute , private location : Location ,

              private rts : RequestChangeMessageTemplateTypeService , private gss : GeneralSearchService , private gas : GeneralAllService ,

              private ems : ErrorMessagesService , private ns : NotificationService , private aus : AuthenticationService) { 

    this.entriesSearchedOb = this.gss.entriesSearched$.subscribe((result : RequestChangeMessageTemplateType[]) => {
  ...
  public entries : RequestChangeMessageTemplateType[] = [];
  ...
  public trackByNum(idx : number , entry : RequestChangeMessageTemplateType) : string {
