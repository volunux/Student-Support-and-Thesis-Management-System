...
@Component({
  ...
  'selector' : 'app-rcmtt-entry-update',

  'templateUrl' : './rcmtt-entry-update.component.html',

  'styleUrls' : ['./rcmtt-entry-update.component.css'] ,
...
export class RequestChangeMessageTemplateTypeEntryUpdateComponent implements OnInit {
