...
export class RequestCredentialEntriesComponent implements OnInit {

  constructor(private route : ActivatedRoute , private location : Location ,

              private rcs : RequestCredentialService , private gss : GeneralSearchService , private gas : GeneralAllService ,

              private ems : ErrorMessagesService , private ns : NotificationService , private aus : AuthenticationService) { 

    this.entriesSearchedOb = this.gss.entriesSearched$.subscribe((result : RequestCredential[]) => {
  ...
  public entries : RequestCredential[] = [];
  ...
  public trackByNum(idx : number , entry : RequestCredential) : string {
  ...
  public getAllEntry(sq : SearchQuery) : void {
   ...
   this.rcs.getAllEntry(sq)
    ...
    .subscribe((result : RequestCredential[]) => {
