...
@Component({
  ...
  'selector' : 'app-acmtt-entry-delete',

  'templateUrl' : './acmtt-entry-delete.component.html',

  'styleUrls' : ['./acmtt-entry-delete.component.css'] ,
...
export class AccountChangeMessageTemplateTypeEntryDeleteComponent implements OnInit {
