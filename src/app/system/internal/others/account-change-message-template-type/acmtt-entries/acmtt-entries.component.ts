...
@Component({
  ...
  'selector' : 'app-acmtt-entries',

  'templateUrl' : './acmtt-entries.component.html',

  'styleUrls' : ['./acmtt-entries.component.css'] ,
...
export class AccountChangeMessageTemplateTypeEntriesComponent implements OnInit {

  constructor(private route : ActivatedRoute , private location : Location ,

              private rts : AccountChangeMessageTemplateTypeService , private gss : GeneralSearchService , private gas : GeneralAllService ,

              private ems : ErrorMessagesService , private ns : NotificationService , private aus : AuthenticationService) { 

    this.entriesSearchedOb = this.gss.entriesSearched$.subscribe((result : AccountChangeMessageTemplateType[]) => {
  ...
  public entries : AccountChangeMessageTemplateType[] = [];
  ...
  public trackByNum(idx : number , entry : AccountChangeMessageTemplateType) : string {
