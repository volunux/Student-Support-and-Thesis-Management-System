...
export class AccountChangeMessageTemplateTypeService {
  ...
  public getAllEntry(params : SearchQuery) : Observable<AccountChangeMessageTemplateType[]> {

  	let	link = `${this.apiConfig.host}/${this.$sa}/entries`;

    let httpOptions = {'params' : params};

    return this.http.get<AccountChangeMessageTemplateType[]>(link , httpOptions)

      .pipe(
              tap((value : AccountChangeMessageTemplateType[]) => console.log(value)) ,

              delay(2000) ,

              catchError(this.handleError<AccountChangeMessageTemplateType[]>(`${this.$systemType} Entries` , null))
        )

  }

  public getEntry(entry : string) : Observable<AccountChangeMessageTemplateType> {

  	let	link = `${this.apiConfig.host}/${this.$sa}/entry/${entry}/detail`;

  	return this.http.get<AccountChangeMessageTemplateType>(link)
       
       .pipe(

          tap((entry : AccountChangeMessageTemplateType) => console.log(entry)) ,

          delay(2000) ,

          catchError(this.handleError<AccountChangeMessageTemplateType>(`${this.$systemType} Entry` , null))
        )
  }
  ...
  public addEntry$(internal : AccountChangeMessageTemplateType) : Observable<General> {

    let  link = `${this.apiConfig.host}/${this.$sa}/entry/create`;

    return this.http.post<AccountChangeMessageTemplateType>(link , internal)

      .pipe(

          tap((entry : General) => console.log(entry)) ,

          map((entry : AccountChangeMessageTemplateType) => { return {'created' : true , '$data' : entry}; }) ,

          catchError(this.handleError<AccountChangeMessageTemplateType>(`${this.$systemType} Entry` , null))
        )
  }

  public updateEntry(entry : string) : Observable<AccountChangeMessageTemplateType> {
  ...
  public updateEntry$(entry : string , body : AccountChangeMessageTemplateType) : Observable<General> {

    let  link = `${this.apiConfig.host}/${this.$sa}/entry/${entry}/update`;

  return this.http.put<AccountChangeMessageTemplateType>(link , body)

      .pipe(

        map((entry : AccountChangeMessageTemplateType) => { return { 'updated' : true , '$data' : entry }; }) ,
  ...
  public $deleteManyEntry(arrayIdx : number[]) : Observable<General> {
    ...
    return this.http.patch(link , body)
      ...
      .pipe(
        ...
        catchError(this.handleError<AccountChangeMessageTemplateType[]>(`${this.$systemType} Entries Delete` , null))
  ...
  public deleteAllEntry() : Observable<any> {
    ...
    return this.http.get(link)
      ...
      .pipe(
        ...
        catchError(this.handleError<AccountChangeMessageTemplateType[]>(`${this.$systemType} Entry or Entries Delete` , null))

        );
  }

  public $deleteAllAccountChangeMessageTemplateType() : Observable<General> {
