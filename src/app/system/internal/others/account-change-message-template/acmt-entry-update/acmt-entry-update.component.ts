...
@Component({
  ...
  'selector' : 'app-acmt-entry-update',

  'templateUrl' : './acmt-entry-update.component.html',

  'styleUrls' : ['./acmt-entry-update.component.css'] ,
...
export class AccountChangeMessageTemplateEntryUpdateComponent implements OnInit {

  constructor(private route : ActivatedRoute , private router : Router , private dps : AccountChangeMessageTemplateService , private dpfs : AccountChangeMessageTemplateFormService ,

  						private gifs : GeneralMessageTemplateFormService , private giecs : GeneralMessageTemplateEntryChangeService , private ems : ErrorMessagesService , private ns : NotificationService) {
