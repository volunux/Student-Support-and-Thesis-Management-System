...
@Component({
  ...
  'selector' : 'app-acmt-entry-detail',

  'templateUrl' : './acmt-entry-detail.component.html',

  'styleUrls' : ['./acmt-entry-detail.component.css'] ,
...
export class AccountChangeMessageTemplateEntryDetailComponent implements OnInit {

  constructor(private route : ActivatedRoute , private ems : ErrorMessagesService , private dps : AccountChangeMessageTemplateService ) { 
