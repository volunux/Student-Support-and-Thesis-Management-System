...
@Component({
  ...
  'selector' : 'app-acmt-entries',

  'templateUrl' : './acmt-entries.component.html',

  'styleUrls' : ['./acmt-entries.component.css'] ,
...
export class AccountChangeMessageTemplateEntriesComponent implements OnInit {

  constructor(private route : ActivatedRoute , private location : Location ,

              private dps : AccountChangeMessageTemplateService , private gss : GeneralSearchService , private gas : GeneralAllService ,

              private ems : ErrorMessagesService , private ns : NotificationService , private aus : AuthenticationService) { 

    this.entriesSearchedOb = this.gss.entriesSearched$.subscribe((result : AccountChangeMessageTemplate[]) => {
  ...
  public entries : AccountChangeMessageTemplate[] = [];
  ...
  public trackByNum(idx : number , entry : AccountChangeMessageTemplate) : string {
