...
@Component({
  ...
  'selector' : 'app-rcmt-entry-delete',

  'templateUrl' : './rcmt-entry-delete.component.html',

  'styleUrls' : ['./rcmt-entry-delete.component.css'] ,
...
export class RequestChangeMessageTemplateEntryDeleteComponent implements OnInit {
