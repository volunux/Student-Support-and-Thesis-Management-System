...
@Component({
  ...
  'selector' : 'app-rcmt-entries',

  'templateUrl' : './rcmt-entries.component.html',

  'styleUrls' : ['./rcmt-entries.component.css'] ,
...
export class RequestChangeMessageTemplateEntriesComponent implements OnInit {

  constructor(private route : ActivatedRoute , private location : Location ,

              private rts : RequestChangeMessageTemplateService , private gss : GeneralSearchService , private gas : GeneralAllService ,

              private ems : ErrorMessagesService , private ns : NotificationService , private aus : AuthenticationService) { 

    this.entriesSearchedOb = this.gss.entriesSearched$.subscribe((result : RequestChangeMessageTemplate[]) => {
  ...
  public entries : RequestChangeMessageTemplate[] = [];
  ...
  public trackByNum(idx : number , entry : RequestChangeMessageTemplate) : string {
