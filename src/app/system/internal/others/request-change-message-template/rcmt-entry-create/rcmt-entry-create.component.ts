...
@Component({
  ...
  'selector' : 'app-rcmt-entry-create',

  'templateUrl' : './rcmt-entry-create.component.html',

  'styleUrls' : ['./rcmt-entry-create.component.css'] ,
...
export class RequestChangeMessageTemplateEntryCreateComponent implements OnInit {
