...
@Component({
  ...
  'selector' : 'app-rcmt-entry-detail',

  'templateUrl' : './rcmt-entry-detail.component.html',

  'styleUrls' : ['./rcmt-entry-detail.component.css'] ,
...
export class RequestChangeMessageTemplateEntryDetailComponent implements OnInit {

  constructor(private route : ActivatedRoute , private ems : ErrorMessagesService , private rts : RequestChangeMessageTemplateService ) { 
