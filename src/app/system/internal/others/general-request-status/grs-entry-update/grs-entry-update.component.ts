...
@Component({
  ...
  'selector' : 'app-general-request-status-entry-update',

  'templateUrl' : './grs-entry-update.component.html',

  'styleUrls' : ['./grs-entry-update.component.css'] ,
...
export class GeneralRequestStatusEntryUpdateComponent implements OnInit {
