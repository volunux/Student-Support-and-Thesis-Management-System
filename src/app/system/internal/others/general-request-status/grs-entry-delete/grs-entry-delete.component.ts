...
@Component({
  ...
  'selector' : 'app-general-request-status-entry-delete',

  'templateUrl' : './grs-entry-delete.component.html',

  'styleUrls' : ['./grs-entry-delete.component.css'] ,
...
export class GeneralRequestStatusEntryDeleteComponent implements OnInit {

  constructor(private route : ActivatedRoute , private router : Router , private rts : GeneralRequestStatusService , private iofs : GeneralRequestStatusFormService ,
  ...
  ngOnInit() : void {
    ...
    .subscribe((result : { [key : string] : any }) => {
      ...
      if (result == null) {
        ...
        this.entryForm.addControl('word' , new FormControl('' , this.iofs.otherCtrls.word));

        this.entryForm.addControl('other_name' , new FormControl('' , this.iofs.otherCtrls.other_name));
  ...
  public changeEntry(body : { [key : string] : any }) : any {
    ...
    this.rts.deleteEntry$(this.eslug)
      ...
      .subscribe((result : GeneralRequestStatus) => {
