...
@Component({
  ...
  'selector' : 'app-general-request-status-entries',

  'templateUrl' : './grs-entries.component.html',

  'styleUrls' : ['./grs-entries.component.css'] ,
...
export class GeneralRequestStatusEntriesComponent implements OnInit {

  constructor(private route : ActivatedRoute , private location : Location ,

              private rts : GeneralRequestStatusService , private gss : GeneralSearchService , private gas : GeneralAllService ,

              private ems : ErrorMessagesService , private ns : NotificationService , private aus : AuthenticationService) { 

    this.entriesSearchedOb = this.gss.entriesSearched$.subscribe((result : GeneralRequestStatus[]) => {
  ...
  public entries : GeneralRequestStatus[] = [];
  ...
  public trackByNum(idx : number , entry : GeneralRequestStatus) : string {
