...
@Component({
  ...
  'selector' : 'app-general-request-status-entry-create',

  'templateUrl' : './grs-entry-create.component.html',

  'styleUrls' : ['./grs-entry-create.component.css'] ,
...
export class GeneralRequestStatusEntryCreateComponent implements OnInit {
