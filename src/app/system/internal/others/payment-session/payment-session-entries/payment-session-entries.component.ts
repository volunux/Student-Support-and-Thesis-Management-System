...
@Component({
  ...
  'selector' : 'app-payment-session-entries',

  'templateUrl' : './payment-session-entries.component.html',

  'styleUrls' : ['./payment-session-entries.component.css'] ,
...
export class PaymentSessionEntriesComponent implements OnInit {

  constructor(private route : ActivatedRoute , private location : Location ,

              private dps : PaymentSessionService , private gss : GeneralSearchService , private gas : GeneralAllService ,

              private ems : ErrorMessagesService , private ns : NotificationService , private aus : AuthenticationService) { 

    this.entriesSearchedOb = this.gss.entriesSearched$.subscribe((result : PaymentSession[]) => {
  ...
  public trackByNum(idx : number , entry : PaymentSession) : string {
